...
On a linux based system, it will ask you to install all necesary dependencies automagically, the first time you run the program. You can review all the installed packages at FUNC/dependencies.sh.
